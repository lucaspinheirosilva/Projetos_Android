...
public class ListaProdutosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabAdicionarProduto = findViewById(R.id.fab_AddProduto);
        fabLocalizarProduto = findViewById(R.id.fab_localizarProdutos);
        rcrvwListagemProduto= findViewById(R.id.rcrvw_listarProdutos);
        edtxt_localizarPorNome = findViewById(R.id.edtxt_AcharPorNOME);
        biparProduto = findViewById(R.id.btn_biparProduto);
        ...
        rcrvwListagemProduto.addOnItemTouchListener(
                new RecyclerItemClickListiner(getApplicationContext(),
                    ...
                    public void onLongItemClick(View view, int position) {
                        ...
                        Intent intent = new Intent(ListaProdutosActivity.this, AddListaProdutoActivity.class);
        ...
        //***chama o ALERTDIALOG para cadastrar um novo produto***
        ...
        edtxt_localizarPorNome.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                listaProdutosAdapter = new ListaProdutosAdapter(listProdutos);
                ...
                rcrvwListagemProduto.setAdapter(listaProdutosAdapter);
        ...
        biparProduto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
